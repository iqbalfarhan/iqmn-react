...
const AssignmentUploadMediaSheet: FC<Props> = ({ assignment, children }) => {
  ...
  const handleUploadMedia = () => {
    post(route('assignment.upload-media', assignment.id), {
      preserveScroll: true,
      onSuccess: () => {
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>Upload media to assignment</SheetDescription>
        </SheetHeader>
...
export default AssignmentUploadMediaSheet;
