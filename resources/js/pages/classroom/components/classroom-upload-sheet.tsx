...
const ClassroomUploadMediaSheet: FC<Props> = ({ classroom, children }) => {
  ...
  const handleUploadMedia = () => {
    post(route('classroom.upload-media', classroom.id), {
      preserveScroll: true,
      onSuccess: () => {
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>Upload media to classroom</SheetDescription>
        </SheetHeader>
...
export default ClassroomUploadMediaSheet;
