...
const MaterialUploadMediaSheet: FC<Props> = ({ material, children }) => {
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>Upload media to material</SheetDescription>
        </SheetHeader>
...
export default MaterialUploadMediaSheet;
